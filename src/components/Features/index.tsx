    ...
    <>
      <section id="features" className="py-16 md:py-20 lg:py-28">
        <div className="container">
          <SectionTitle
            title="知识付费"
            paragraph="我们汇聚了各领域的专家和行业领袖，提供深度的在线课程和专题讲座。无论是职业技能提升、创业指导，还是个人成长，我们都为用户提供高质量的学习资源，帮助他们在激烈的竞争中脱颖而出。用户可以根据自己的需求，选择适合的课程，通过知识的积累实现自我价值的提升。"
            center
          />
          ...
          <div className="grid grid-cols-1 gap-x-8 gap-y-14 md:grid-cols-2 lg:grid-cols-3">
            <SingleFeature feature={{
              ...
              title: "高质量内容",
              paragraph: "知识付费平台汇聚行业专家和学者，提供深入、专业的课程和讲座，确保用户获得实用且权威的知识",
            }} />
            <SingleFeature feature={{
              id: 2,
              icon: (
              ...
              title: "灵活学习方式",
              paragraph: "用户可以根据自己的时间安排选择学习内容，支持随时随地访问，满足个性化学习需求",
            }} />
            <SingleFeature feature={{
              id: 3,
              icon: (
              ...
              title: "互动与社群",
              paragraph: "许多知识付费平台提供互动功能，允许用户提问、讨论和分享，促进学习者之间的交流与合作",
            }} />
          </div>
        </div>
      </section>
